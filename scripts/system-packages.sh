...
apt install -y  sudo ssh git meson gcc g++ gcc-i686-linux-gnu g++-i686-linux-gnu libxvmc-dev
...
apt install -y  libc6-dev-x32-i386-cross libzstd-dev libx11-xcb-dev
